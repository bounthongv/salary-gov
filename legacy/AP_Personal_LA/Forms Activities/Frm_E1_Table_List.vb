Public Class Frm_E1_Table_List
    ...
    Private Sub Button1_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Me.Close()
    End Sub
    Private Sub Frm_E1_Table_List_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load


        Fg1.FormatString = ">ລ/ດ  |<ກົມ   |<ກົມ                                |<ພະແນກ                      |^ວັນທີ              |<ໝາຍເຫດ                              "
        FG2.FormatString = "ລດ |<ຊື່ວິຊາ                |<ນັບແຕ່ປີຈົບ(ລະດັບການສືກສາສູູງສຸດທີ່ໄດ້ຮັບ)|>ລວມ |>ເອກ |>ໂທ  |>ຕີ  |>ສູງ |>ກາງ |>ລວມ |>ເອກ |>ໂທ  |>ຕີ  |>ສູງ |>ກາງ |<ໝາຍເຫດ     "
    ...
    Private Sub loaddata()
        ...
        With RSC
            Dim aa As String
            aa = "SELECT  * from AP_E1  where 1=1      " & Sql & " " & shr_section & " " & shr_Department & "   ORDER BY E1_Bill "
            Call LoadRs(aa, RSC)
            ...
            If .RecordCount <> 0 Then
                ...
                While Not .EOF()
                    Fg1.AddItem(.AbsolutePosition & _
                                 Chr(9) & Trim((RSC.Fields("E1_Bill").Value).ToString) & _
                                Chr(9) & Trim((RSC.Fields("Sections").Value).ToString) & _
                                  Chr(9) & Trim((RSC.Fields("Department").Value).ToString) & _
                                Chr(9) & Format(CDate(RSC.Fields("DT_E1").Value), "dd/MM/yyyy"))
    ...
    Private Sub loaddata_list()
        ...
        With RSC
            Dim aa As String
            aa = "SELECT  * from AP_E1_Item  where E1_Bill=N'" & SaleID & "'    ORDER BY E1_Bill "
            Call LoadRs(aa, RSC)
    ...
    Private Sub Button9_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnAddNew.Click
        ...
        MDEdit = False
        Frm_E1_Table.MdiParent = FrmAPInvioce
        Frm_E1_Table.WindowState = FormWindowState.Maximized
        Frm_E1_Table.ShowIcon = False
        Frm_E1_Table.Show()
    End Sub
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        With RSC
         ...
         "    FROM         AP_E1 INNER JOIN " & _
               "       AP_E1_Item ON AP_E1.E1_Bill = AP_E1_Item.E1_Bill  WHERE AP_E1.E1_Bill='" & Trim(Fg1.get_TextMatrix(Fg1.Row, 1)) & "'"

            Call LoadRs(sa, RSC)
            If .RecordCount = 0 Then MsgBox("Data empty", vbInformation, "Check") : Exit Sub
            Dim Frm As New FrmPreview
            Dim Rpt As New Report_E1_list
