Public Class Frm_Employee_Ticket_List
    ...
    Private Sub Button1_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Me.Close()
    End Sub
    Private Sub Frm_Employee_Ticket_List_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        FG2.FormatString = "ລ/ດ |<ວັນທີ    |<ເນື້ອໃນ                  |<ຂໍໃຫ້  |<ຊື່ ແລະ ນາມສະກຸນ ຄົນໃນຄອບຄົວ|>ຈ/ນ ມື້ລາພັກ |>ຈ/ນ ມື້ປ່ວຍ |>ຈ/ນ ປີ້|^FOC             |^90%              |^75%               |^50%           "
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        With RSC
            Dim sa As String = "SELECT     AP_Employee_Tecket.Bill_no, AP_Employee_Tecket.DT_year, AP_Employee_Tecket.E_ID, AP_Employee_Tecket.E_nm, AP_Employee_Tecket.Tecket_year, " & _
                   "   AP_Employee_Tecket.Tecket_use, AP_Employee_Tecket.about, AP_Employee_Tecket.Remark, AP_Employee_Tecket.lst_usr, AP_Employee_Tecket.lst_updt, " & _
                   "   AP_Employee_Tecket.Pc_nm, AP_Employee_Tecket.cnt, AP_CV.Name_L, AP_CV.Name_E, AP_CV.Phone, AP_CV.txtV_C, AP_Sections.Sec_nmL, AP_Sections.Sec_id, " & _
                   "   Department.DP_ID, Department.DP_Name, AP_Employee_Tecket_item.E_ID AS Expr1, AP_Employee_Tecket_item.DT, AP_Employee_Tecket_item.detail, AP_Employee_Tecket_item.gave_to, " & _
