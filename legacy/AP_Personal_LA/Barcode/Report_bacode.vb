...
Public Class Report_bacode
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "APInvioce.Report_bacode.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReport_bacode
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_bacode = New Report_bacode
        rpt.Site = Me.Site
        Return rpt
    End Function
