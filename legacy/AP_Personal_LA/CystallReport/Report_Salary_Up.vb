...
Public Class Report_Salary_Up
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "APInvioce.Report_Salary_Up.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReport_Salary_Up
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_Salary_Up = New Report_Salary_Up
        rpt.Site = Me.Site
        Return rpt
    End Function
