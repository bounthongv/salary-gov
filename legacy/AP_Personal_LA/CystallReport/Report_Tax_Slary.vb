...
Public Class Report_Tax_Slary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "APInvioce.Report_Tax_Slary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReport_Tax_Slary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_Tax_Slary = New Report_Tax_Slary
        rpt.Site = Me.Site
        Return rpt
    End Function
