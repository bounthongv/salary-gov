...
Public Class Report_IREP_Chart
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "APInvioce.Report_IREP_Chart.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReport_IREP_Chart
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_IREP_Chart = New Report_IREP_Chart
        rpt.Site = Me.Site
        Return rpt
    End Function
