...
Public Class Report_DEM_Chart
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "APInvioce.Report_DEM_Chart.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReport_DEM_Chart
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_DEM_Chart = New Report_DEM_Chart
        rpt.Site = Me.Site
        Return rpt
    End Function
