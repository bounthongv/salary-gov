...
Public Class Report_DEB_Chart
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "APInvioce.Report_DEB_Chart.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReport_DEB_Chart
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_DEB_Chart = New Report_DEB_Chart
        rpt.Site = Me.Site
        Return rpt
    End Function
