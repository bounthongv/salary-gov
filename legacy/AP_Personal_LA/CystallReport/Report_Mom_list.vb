...
Public Class Report_Mom_list
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "APInvioce.Report_Mom_list.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReport_Mom_list
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_Mom_list = New Report_Mom_list
        rpt.Site = Me.Site
        Return rpt
    End Function
