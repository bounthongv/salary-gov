...
Public Class Report_EP_list
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "APInvioce.Report_EP_list.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReport_EP_list
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_EP_list = New Report_EP_list
        rpt.Site = Me.Site
        Return rpt
    End Function
