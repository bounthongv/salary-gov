...
Public Class Report_Son_list
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "APInvioce.Report_Son_list.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReport_Son_list
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_Son_list = New Report_Son_list
        rpt.Site = Me.Site
        Return rpt
    End Function
