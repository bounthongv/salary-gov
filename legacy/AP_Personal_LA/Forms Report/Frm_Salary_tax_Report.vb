...
Public Class Frm_Salary_tax_Report
    Dim Sql As String
    Private Sub Frm_Salary_tax_Report_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Sql = ""
        shr_Class_vel = ""
        shr_Department = ""
        shr_section = ""
    ...
    " and   month(AP_Salary_in_Month.AtMonth) ='" & Month(DT_Month.Value) & "' and year(AP_Salary_in_Month.AtMonth) ='" & Year(DT_Month.Value) & "' order by AP_CV.order_no   "
            ...
            Dim Rpt As New Report_Tax_Slary
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Dim Rslaw As New ADODB.Recordset
            ...
            Try
                With RSC
                aa = "SELECT     AP_Salary_in_Month.Name_L,AP_Salary_in_Month.total_amount, AP_Salary_in_Month.Employee_LAK,  AP_Salary_in_Month.MOvertimeTotal + AP_Salary_in_Month.total_amount AS aa, " & _
                  "    AP_Salary_in_Month.Money_Befor,  " & _
                   "   AP_Salary_in_Month.Tax_Level1 , AP_Salary_in_Month.Tax_Level2, AP_Salary_in_Month.Tax_Level3, AP_Salary_in_Month.Tax_Level4,AP_Salary_in_Month.Tax_Level5,AP_Salary_in_Month.Tax_Level6,AP_Salary_in_Month.Tax_Level7,  " & _
                  "    AP_Salary_in_Month.tax_money, AP_Salary_in_Month.Total_Money_curr " & _
    ...
    " and   month(AP_Salary_in_Month.AtMonth) ='" & Month(DT_Month.Value) & "' and year(AP_Salary_in_Month.AtMonth) ='" & Year(DT_Month.Value) & "' order by AP_CV.order_no   "
                ...
                xlWorkSheet.Cells(1, 2).Value = "ຈຳນວນເງິນເດືອນທີໄດ້ຮັບທັງໝົດ"
                xlWorkSheet.Cells(1, 3).Value = "ເງິນປະກັນສັງຄົມ"
                xlWorkSheet.Cells(1, 4).Value = "ລວມເງິນວຽກລວງເວລາ ແລະ ລາຍຮັບອື່ນໆ"
                xlWorkSheet.Cells(1, 5).Value = "ລາຍຮັບຫຼັງຫັກປະກັນສັງຄົມແລະ ເງີນເອົາໄປຫັກອາກອນ"
                xlWorkSheet.Cells(1, 6).Value = "ເງິນຫຼຸດຜ່ອນພື້ນຖານປະຈະເດືອນ 1000,000 ກີບ"
                xlWorkSheet.Cells(1, 7).Value = "5% "
                xlWorkSheet.Cells(1, 8).Value = "10% "
                xlWorkSheet.Cells(1, 9).Value = "12%"
                xlWorkSheet.Cells(1, 10).Value = "15%"
                xlWorkSheet.Cells(1, 11).Value = "20%"
                xlWorkSheet.Cells(1, 12).Value = "24%"
                xlWorkSheet.Cells(1, 13).Value = "ຈຳນວນອາກອນທີ່ຕ້ອງມອບ"
                xlWorkSheet.Cells(1, 14).Value = "ລວມເງິນເດືອນທີໄດ້ຮັບທັງໝົດ "
                    ...
                    xlWorkSheet.SaveAs("" & Trim(txtpart.Text) & "\ຕາຕະລາງອາກອນ.xlsx")
                    xlWorkBook.Close()
                    xlApp.Quit()
                    releaseObject(xlApp)
