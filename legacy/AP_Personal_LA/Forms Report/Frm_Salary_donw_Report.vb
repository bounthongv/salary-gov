Public Class Frm_Salary_donw_Report
    Dim Sql As String
    Private Sub Frm_Salary_donw_Report_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Sql = ""
        shr_Class_vel = ""
        shr_Department = ""
        shr_section = ""
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
     ...
     "       AP_Province.PV_ID, AP_Province.PV_nm, AP_Donw_Personal.txtkhor_tok_long, AP_Donw_Personal.txtAccount_clss_level, AP_Donw_Personal.DT_dn, AP_Donw_Personal.remark, AP_Donw_Personal.type_dn_id, AP_Donw_Personal.type_dn " & _
            "     FROM         AP_CV INNER JOIN " & _
                  ...
                  "    AP_Province ON AP_District.PV_id = AP_Province.PV_ID INNER JOIN  " & _
                   "   AP_Donw_Personal ON AP_CV.E_ID = AP_Donw_Personal.E_ID CROSS JOIN " & _
                    "  AP_Office  WHERE 1=1  " & Sql & "  " & shr_type_dn & "" & shr_Class_vel & " " & shr_Department & " " & shr_section & " " & shr_phuk & " " & shr_job_lut & "" & Shr_persen & "  order by AP_CV.cmbclass desc "
            Call LoadRs(aa, RSC)
            If .RecordCount = 0 Then MsgBox("Data empty", vbInformation, "Check") : Exit Sub
            Dim Frm As New FrmPreview
            Dim Rpt As New Report_Salary_donw
    ...
    Private Sub Chk_Dt_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Chk_Dt.CheckedChanged
        If Chk_Dt.Checked = True Then
            ...
            Sql = " AND AP_Donw_Personal.DT_dn between '" & Format(txtFdate.Value, "MM/dd/yyyy") & "'AND '" & Format(txtTdate.Value, "MM/dd/yyyy") & "'"
    ...
    Private Sub DT_month_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DT_month.ValueChanged
        Sql = " and  month(AP_Donw_Personal.DT_dn) ='" & Month(DT_month.Value) & "' and year(AP_Donw_Personal.DT_dn) ='" & Year(DT_month.Value) & "' "
    End Sub


    Private Sub DT_year_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DT_year.ValueChanged
        Sql = " and    year(AP_Donw_Personal.DT_dn) ='" & Year(DT_year.Value) & "' "
    End Sub
    ...
    Private Sub chk_percen_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chk_percen.CheckedChanged
        If chk_percen.Checked = True Then
            ...
            Shr_persen = ""
            Shr_persen = " AND AP_Donw_Personal.percen = N'" & cmb_percen.Text & "' "
        Else
            cmb_percen.Text = ""
    ...
    Private Sub chk_dn_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chk_dn.CheckedChanged
        If chk_dn.Checked = True Then
            cmb_type_dn.Enabled = True
            Call load_Cmb("select dn_nm from Type_donw", "dn_nm", cmb_type_dn)
            cmb_type_dn.SelectedIndex = 0
            shr_type_dn = " AND AP_Donw_Personal.type_dn_id = N'" & txtdn_id.Text & "' "

        Else
            cmb_type_dn.Enabled = False
            cmb_type_dn.Text = ""
            shr_type_dn = ""
    ...
    Private Sub cmb_type_dn_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmb_type_dn.SelectedIndexChanged
        Dim RSC As New ADODB.Recordset
