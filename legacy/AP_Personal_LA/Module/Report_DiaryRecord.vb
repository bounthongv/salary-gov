...
Public Class Report_DiaryRecord
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "APInvioce.Report_DiaryRecord.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReport_DiaryRecord
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_DiaryRecord = New Report_DiaryRecord
        rpt.Site = Me.Site
        Return rpt
    End Function
